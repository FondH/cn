...
const int MAX_DELAY_MS = 350; // 最大延迟时间（毫秒）
const double MAX_DELAY_RATE = 0.01;
...
int Reciver::get_connection(int type) {
    /*等待连接 reci*/
    ...
    case 1:
        ...
        CreateThread(NULL, 0, ReciHandler, (LPVOID)this, 0, NULL);
        send_st = clock();
        break;
    ...
    case 2:
        cout << "\nGBN SENDING " << endl;
        send_st = clock();
        CreateThread(NULL, 0, GBNReciHandler, (LPVOID)this, 0, NULL);
        break;
    default:
        cout << "\nSR SENDING " << endl;
        send_st = clock();
        CreateThread(NULL, 0, SRReciHandler, (LPVOID)this, 0, NULL);
        break;
    }
